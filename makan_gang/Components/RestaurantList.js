                  ...
                  <View>
                    <View style={{flex:1}} styleName='horizontal'>
                      <View style = {{width:Dimensions.get('window').width / 2 , flex:3/4 }}>
                        ...
                        <Button style={{flex:1/4 , backgroundColor:'#FF5733' ,paddingTop:5, paddingBottom:5 , paddingLeft:5 , paddingRight:5 }} styleName = 'tight' onPress ={() => this.props.button('Details' , {dataArr:restaurant})} >
